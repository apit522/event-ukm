...
<div class="bg-ungu flex flex-col justify-center">
    ...
    <div class="bg-white  w-[1127px] mx-auto my-auto flex flex-col items-center mt-3 mb-3 rounded-sm justify-center py-4 " id="containerTarget">
        ...
        <div class="w-[649px] h-[50px] bg-white rounded-lg flex items-center justify-evenly my-auto mb-3  border-2 border-secondary">
        ...
        @if(time() >= strtotime($presale->start_date) && time() <= strtotime($presale->due_to))
            ...
            @else
            <div class="w-[649px] h-[50px] bg-black rounded-lg flex items-center justify-evenly my-auto mb-3">
            ...
            <div id="disqus_thread" class="bg-white  w-[1127px] mx-auto my-auto flex flex-col items-center  rounded-sm justify-center p-10 mb-24"">
        </div>
        <script>
            /**
