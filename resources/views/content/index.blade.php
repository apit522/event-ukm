...
<div class="bg-ungu">
    ...
    <div class="py-12">
        <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-32 mx-auto max-w-screen-lg">
            ...
            <div class="flex  relative h-[800px] w-[486px] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md mb-3 min-h-[800px]">
                ...
                <div class="flex items-center py-5 justify-between">
                    <div class="flex  items-center -space-x-3">
                        <div data-tooltip="author-2" class="absolute z-50  whitespace-normal break-words  px-3 text-2xl font-bold text-black focus:outline-none">
                            {{ $post['ukm_username'] }}
                        </div>
                    </div>
                ...
                <div class="flex items-center justify-between p-3">
                    <div class="flex items-center -space-x-2">
                        <div data-tooltip="author-2" class="flex flex-col justify-center whitespace-normal break-words rounded-lg border-[1px] border-black bg-ungu py-1.5 px-3 text-lg h-[60px] items-center text-center font-normal w-[120px] text-white focus:outline-none">
                    ...
                    <div class="flex items-center -space-x-2">
                        <div data-tooltip="author-2" class="flex flex-col justify-center whitespace-normal break-words rounded-lg border-[1px] border-black bg-ungu py-1.5 px-3 text-lg h-[60px] items-center  text-center font-normal w-[120px] text-white focus:outline-none">
                            <button onclick="redirectToComment({{ $post['id'] }})"> Komentar </button>
                        </div>
                    </div>

                    <div data-tooltip="author-2" class="flex flex-col whitespace-normal break-words rounded-lg border-[1px] border-black bg-ungu py-1.5 px-3 text-lg h-[60px]  text-center  justify-center font-normal w-[120px] text-white focus:outline-none">
                        <button onclick="shareAndCopy({{$post['id']}})">
                            Bagikan
                        </button>
                    </div>
